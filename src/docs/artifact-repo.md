...
path: "/artifact-repo"
date: "2018-10-05"
title: "Configuring Your Artifact Repository"
---
...
In order for KubeBuild to use your artifact repository, you must configure it as the default repository.
...
In `values.yaml` edit from the next step:
```
...
artifactRepository:
  s3:
